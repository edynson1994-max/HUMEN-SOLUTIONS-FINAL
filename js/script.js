...
const MP_BACKEND_URL = "https://script.google.com/macros/s/AKfycbyqEqAlPDChbizXLtniY2n4Psf6A2HgMs0O7bMdNRHMG1uHFz4VZMX89d9M60HszZSbKA/exec";
    ...
    form.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            if (data && data.init_point) {
                ...
                throw new Error(data && data.error ? data.error : "Respuesta inválida del servidor de pagos.");
            }

        } catch (err) {

            console.error(err);
            errorBox.textContent = "No pudimos iniciar el pago. Intenta de nuevo o usa 'Solicitar Cotización'.";
