...
mostrarResultado(precio, detalle) {
    ...
    const precioConDescuento = precio * (1 - DESCUENTO_PAGO_RAPIDO);
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function abrir() {
        ...
        const precioFinal = Cotizador.precioConDescuento || precio;
    ...
    form.addEventListener("submit", async (e) => {
        ...
        const datos = {
            ...
            monto: Cotizador.precioConDescuento || Cotizador.precioActual,
            montoSinDescuento: Cotizador.precioActual,
